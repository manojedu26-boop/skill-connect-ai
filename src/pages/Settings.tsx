...
import { X, UploadCloud, Medal, Github, Linkedin, Globe, Briefcase, GraduationCap, Plus, User, Building2, Rocket, Heart } from "lucide-react";
              ...
              {user.role === 'freelancer' ? (
                ...
                <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-8">
                   <div className="bento-card bg-[#0B1221] text-white p-8 relative overflow-hidden group">
                      ...
                      <div className="space-y-4">
                         <div className="p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-teal/30 transition-all cursor-pointer">
                         ...
                         <div className="p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-teal/30 transition-all cursor-pointer">
                            <p className="text-xs font-black text-teal mb-1 tracking-widest uppercase">Global Impact</p>
                            <p className="text-sm text-slate-300 font-medium">Quantify your venture's influence on the broader digital ecosystem.</p>
                         </div>
                      </div>
                   </div>

                   <div className="bento-card bg-white p-8 flex flex-col justify-between">
                      <div>
                        ...
                        <div className="space-y-6">
                           ...
                           <div className="h-2 w-full bg-slate-50 rounded-full overflow-hidden">
                              <div className="h-full w-[85%] bg-orange" />
                           </div>
                           <div className="flex items-center justify-between">
                              <span className="text-[11px] font-black text-slate-400 uppercase">Retention Score</span>
                              <span className="text-xs font-black text-teal">ELITE</span>
                           </div>
                           <div className="h-2 w-full bg-slate-50 rounded-full overflow-hidden">
                              <div className="h-full w-[94%] bg-teal" />
                           </div>
                        </div>
                      </div>
                      <Button variant="outline" className="mt-8 w-full h-12 rounded-xl border-dashed border-slate-200 text-navy font-black text-[10px] uppercase tracking-widest hover:bg-slate-50">
                         Optimize Culture Profile
                      </Button>
                   </div>
                </div>
              )}
